---
title: "TMRC3 202305: Differential Expression analyses"
...
tc_all_clinic_de_sva <- all_pairwise(tc_clinic_type, model_batch = "svaseq", parallel = FALSE,
                                     filter = TRUE)
...
#  rda = glue("rda/tc_all_clinic_table_sva-v{ver}.rda"),
  excel = glue("{xlsx_prefix}/compare_clinics/tc_all_clinic_table_sva-v{ver}.xlsx"))
tc_all_clinic_table_sva
tc_all_clinic_sig_sva <- extract_significant_genes(
  tc_all_clinic_table_sva,
  excel = glue("{xlsx_prefix}/compare_clinics/tc_clinic_type_sig_sva-v{ver}.xlsx"))
...
increased_tumaco_categories_up <- simple_gprofiler(
  ...
  excel = glue("analyses/3_cali_and_tumaco/GSEA/tumaco_cateogies_up-v{ver}.xlsx"))
...
increased_cali_categories <- simple_gprofiler(
  ...
  excel = glue("analyses/3_cali_and_tumaco/GSEA/cali_cateogies_up-v{ver}.xlsx"))
...
tc_eosinophils_clinic_table_nobatch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/clinic_cf/Eosinophils/tc_eosinophils_clinic_table_nobatch-v{ver}.xlsx"))
tc_eosinophils_clinic_table_nobatch
tc_eosinophils_clinic_sig_nobatch <- extract_significant_genes(
  tc_eosinophils_clinic_table_nobatch,
  excel = glue("{xlsx_prefix}/clinic_cf/Eosinophils/tc_eosinophils_clinic_sig_nobatch-v{ver}.xlsx"))
...
tc_eosinophils_clinic_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/clinic_cf/Eosinophils/tc_eosinophils_clinic_table_sva-v{ver}.xlsx"))
tc_eosinophils_clinic_table_sva
tc_eosinophils_clinic_sig_sva <- extract_significant_genes(
  tc_eosinophils_clinic_table_sva,
  excel = glue("{xlsx_prefix}/clinic_cf/Eosinophils/tc_eosinophils_clinic_sig_sva-v{ver}.xlsx"))
...
tc_biopsies_clinic_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/clinic_cf/Biopsies/tc_biopsies_clinic_table_sva-v{ver}.xlsx"))
tc_biopsies_clinic_table_sva
tc_biopsies_clinic_sig_sva <- extract_significant_genes(
  tc_biopsies_clinic_table_sva,
  excel = glue("{xlsx_prefix}/clinic_cf/Biopsies/tc_biopsies_clinic_sig_sva-v{ver}.xlsx"))
...
tc_monocytes_table_nobatch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/clinic_cf/Monocytes/tc_monocytes_clinic_table_nobatch-v{ver}.xlsx"))
tc_monocytes_table_nobatch
tc_monocytes_sig_nobatch <- extract_significant_genes(
  tc_monocytes_table_nobatch,
  excel = glue("{xlsx_prefix}/clinic_cf/Monocytes/tc_monocytes_clinic_sig_nobatch-v{ver}.xlsx"))
...
tc_monocytes_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/clinic_cf/Monocytes/tc_monocytes_clinic_table_sva-v{ver}.xlsx"))
tc_monocytes_table_sva
tc_monocytes_sig_sva <- extract_significant_genes(
  tc_monocytes_table_sva,
  excel = glue("{xlsx_prefix}/clinic_cf/Monocytes/tc_monocytes_clinic_sig_sva-v{ver}.xlsx"))
...
tc_neutrophils_table_nobatch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/clinic_cf/Neutrophils/tc_neutrophils_table_nobatch-v{ver}.xlsx"))
tc_neutrophils_table_nobatch
tc_neutrophils_sig_nobatch <- extract_significant_genes(
  tc_neutrophils_table_nobatch,
  excel = glue("{xlsx_prefix}/clinic_cf/Neutrophils/tc_neutrophils_sig_nobatch-v{ver}.xlsx"))
...
tc_neutrophils_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/clinic_cf/Neutrophils/tc_neutrophils_table_sva-v{ver}.xlsx"))
tc_neutrophils_table_sva
tc_neutrophils_sig_sva <- extract_significant_genes(
  tc_neutrophils_table_sva,
  excel = glue("{xlsx_prefix}/clinic_cf/Neutrophils/tc_neutrophils_sig_sva-v{ver}.xlsx"))
...
tc_eosinophil_gprofiler <- simple_gprofiler(
  ...
  excel = glue("{xlsx_prefix}/GSEA/eosinophil_clinics_tumaco_up-v{ver}.xlsx"))
tc_eosinophil_gprofiler

clinic_gp <- simple_gprofiler(
  clinic_sigenes,
  excel = glue("{xlsx_prefix}/GSEA/both_clinics_cali_up-v{ver}.xlsx"))
...
tc_eosinophils_gp <- simple_gprofiler(
  ...
  excel = glue("{xlsx_prefix}/GSEA/eosinophil_clinics-v{ver}.xlsx"))
tc_eosinophils_gp
...
tc_eosinophils_down_gp <- simple_gprofiler(
  tc_eosinophils_sigenes_down,
  excel = glue("{xlsx_prefix}/GSEA/eosinophil_clinics_cali_up-v{ver}.xlsx"))
...
tc_monocytes_up_gp <- simple_gprofiler(
  ...
  excel = glue("{xlsx_prefix}/GSEA/monocyte_clinics-v{ver}.xlsx"))
tc_monocytes_up_gp
...
tc_monocytes_down_gp <- simple_gprofiler(
  tc_monocytes_sigenes_down,
  excel = glue("{xlsx_prefix}/GSEA/monocyte_clinics_cali_up-v{ver}.xlsx"))
...
tc_neutrophils_gp <- simple_gprofiler(
  ...
  excel = glue("{xlsx_prefix}/GSEA/neutrophil_clinics-v{ver}.xlsx"))
...
tc_neutrophils_up_gp <- simple_gprofiler(
  ...
  excel = glue("{xlsx_prefix}/GSEA/neutrophil_clinics_tumaco_up-v{ver}.xlsx"))
...
tc_neutrophils_down_gp <- simple_gprofiler(
  tc_neutrophils_sigenes_down,
  excel = glue("{xlsx_prefix}/GSEA/neutrophil_clinics_cali_up-v{ver}.xlsx"))
...
tc_all_cf_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_valid_cf_table_sva-v{ver}.xlsx"))
tc_all_cf_sig_sva <- extract_significant_genes(
  tc_all_cf_table_sva,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_valid_cf_sig_sva-v{ver}.xlsx"))
...
tc_all_cf_table_batch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_valid_cf_table_batch-v{ver}.xlsx"))
tc_all_cf_sig_batch <- extract_significant_genes(
  tc_all_cf_table_batch,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_valid_cf_sig_batch-v{ver}.xlsx"))
```
...
tc_biopsies_cf_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/Biopsies/tc_biopsies_cf_table_sva-v{ver}.xlsx"))
tc_biopsies_cf_sig_sva <- extract_significant_genes(
  tc_biopsies_cf_table_sva,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_biopsies_cf_sig_sva-v{ver}.xlsx"))
...
tc_biopsies_cf_table_batch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_biopsies_cf_table_batch-v{ver}.xlsx"))
tc_biopsies_cf_sig_batch <- extract_significant_genes(
  tc_biopsies_cf_table_batch,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_biopsies_cf_sig_batch-v{ver}.xlsx"))
```
...
tc_eosinophils_cf_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/Eosinophils/tc_eosinophils_cf_table_sva-v{ver}.xlsx"))
tc_eosinophils_cf_sig_sva <- extract_significant_genes(
  tc_eosinophils_cf_table_sva,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_eosinophils_cf_sig_sva-v{ver}.xlsx"))
...
tc_eosinophils_cf_table_batch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_eosinophils_cf_table_batch-v{ver}.xlsx"))
tc_eosinophils_cf_sig_batch <- extract_significant_genes(
  tc_eosinophils_cf_table_batch,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_eosinophils_cf_sig_batch-v{ver}.xlsx"))
```
...
tc_monocytes_cf_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/Monocytes/tc_monocytes_cf_table_sva-v{ver}.xlsx"))
tc_monocytes_cf_sig_sva <- extract_significant_genes(
  tc_monocytes_cf_table_sva,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_monocytes_cf_sig_sva-v{ver}.xlsx"))
...
tc_monocytes_cf_table_batch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_monocytes_cf_table_batch-v{ver}.xlsx"))
tc_monocytes_cf_sig_batch <- extract_significant_genes(
  tc_monocytes_cf_table_batch,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_monocytes_cf_sig_batch-v{ver}.xlsx"))
```
...
tc_neutrophils_cf_table_sva <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/Neutrophils/tc_neutrophils_cf_table_sva-v{ver}.xlsx"))
tc_neutrophils_cf_sig_sva <- extract_significant_genes(
  tc_neutrophils_cf_table_sva,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_neutrophils_cf_sig_sva-v{ver}.xlsx"))
...
tc_neutrophils_cf_table_batch <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_neutrophils_cf_table_batch-v{ver}.xlsx"))
tc_neutrophils_cf_sig_batch <- extract_significant_genes(
  tc_neutrophils_cf_table_batch,
  excel = glue("{xlsx_prefix}/cf/All_Samples/tc_neutrophils_cf_sig_batch-v{ver}.xlsx"))
```
...
v1_vs_later_table <- combine_de_tables(
  ...
  excel = glue("{xlsx_prefix}/v1_vs_later_tables-v{ver}.xlsx"))
v1_vs_later_sig <- extract_significant_genes(
  v1_vs_later_table,
  excel = glue("{xlsx_prefix}/v1_vs_later_sig-v{ver}.xlsx"))
```
...
tc_sex_table <- combine_de_tables(
  tc_sex_de, excel = glue("{xlsx_prefix}/tc_sex_table-v{ver}.xlsx"))
tc_sex_sig <- extract_significant_genes(
  tc_sex_table, excel = glue("{xlsx_prefix}/tc_sex_sig-v{ver}.xlsx"))
tc_sex_gp <- all_gprofiler(tc_sex_sig)
```

```{r}
tc_sex_cure <- subset_expt(tc_sex, subset = "finaloutcome=='cure'")
tc_sex_cure_de <- all_pairwise(tc_sex_cure, model_batch = "svaseq", filter = TRUE)
tc_sex_cure_de
tc_sex_cure_table <- combine_de_tables(
  tc_sex_cure_de, excel = glue("{xlsx_prefix}/tc_sex_cure_table-v{ver}.xlsx"))
tc_sex_cure_table
tc_sex_cure_sig <- extract_significant_genes(
  tc_sex_cure_table, excel = glue("{xlsx_prefix}/tc_sex_cure_sig-v{ver}.xlsx"))
tc_sex_cure_sig
```
...
```{r}
tc_ethnicity_de <- all_pairwise(tc_etnia_expt, model_batch = "svaseq", filter = TRUE)
tc_ethnicity_de
tc_ethnicity_table <- combine_de_tables(
  tc_ethnicity_de, keepers = ethnicity_contrasts,
  excel = glue("{xlsx_prefix}/tc_ethnicity_table-v{ver}.xlsx"))
tc_ethnicity_table
...
tc_ethnicity_sig <- extract_significant_genes(
  tc_ethnicity_table, excel = glue("{xlsx_prefix}/tc_ethnicity_sig-v{ver}.xlsx"))

ethnicity_cure <- subset_expt(tc_etnia_expt, subset = "finaloutcome=='cure'")
ethnicity_cure_de <- all_pairwise(ethnicity_cure, model_batch = "svaseq", filter = TRUE)
ethnicity_cure_table <- combine_de_tables(
  ethnicity_cure_de, keepers = ethnicity_contrasts,
  excel = glue("{xlsx_prefix}/ethnicity_cure_table-v{ver}.xlsx"))
...
ethnicity_cure_sig <- extract_significant_genes(
  ethnicity_cure_table, excel = glue("{xlsx_prefix}/ethnicity_cure_sig-v{ver}.xlsx"))
ethnicity_cure_sig
```
