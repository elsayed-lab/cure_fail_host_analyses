...
tc_clinical_cf_de_sva <- all_pairwise(tc_clinical_nobiop, filter = TRUE, model_batch = "svaseq")
...
tc_clinical_cf_de_batch <- all_pairwise(tc_clinical_nobiop, filter = TRUE, model_batch = TRUE)
