...
tc_all_cf_de_sva <- all_pairwise(tc_valid, filter = TRUE,
...
tc_all_cf_de_batch <- all_pairwise(tc_valid, filter = TRUE,
...
tc_biopsies_cf_de_sva <- all_pairwise(tc_biopsies_cf, filter = TRUE,
                                      parallel = parallel, model_batch = "svaseq")
...
tc_biopsies_cf_de_batch <- all_pairwise(tc_biopsies_cf, filter = TRUE,
                                        parallel = parallel, model_batch = TRUE)
...
tc_eosinophils_cf_de_sva <- all_pairwise(tc_eosinophils_cf, filter = TRUE,
                                         parallel = parallel, model_batch = "svaseq")
...
tc_monocytes_cf_de_sva <- all_pairwise(tc_monocytes_cf, filter = TRUE,
                                       parallel = parallel, model_batch = "svaseq")
...
tc_monocytes_cf_de_batch <- all_pairwise(tc_monocytes_cf, filter = TRUE,
                                         parallel = parallel, model_batch = TRUE)
...
```{r}
v1_vs_later <- all_pairwise(tc_v1vs, model_batch = "svaseq",
                            parallel = parallel, filter = TRUE)
...
```{r}
tc_sex_de <- all_pairwise(tc_sex, model_batch = "svaseq",
                          parallel = parallel, filter = TRUE)
