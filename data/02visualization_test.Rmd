...
dev.off()
lm_regression_demographics[["forest"]]
lm_regression_demographics[["initial_summary"]]
```
...
numeric_mtrx <- initial_mtrx[, test_queries]
...
```{r}
csea_extracted_regression <- extract_stepwise_regression(numeric_mtrx, query = "finaloutcome",
                                                         factors = c("clinic", "Sex", "Ethnicity", "Age"),
                                                         excel = "excel/tc_regression_table_csea.xlsx")
pp(file = "images/tc_regression_csea.png")
csea_extracted_regression[["forest"]]
dev.off()
csea_extracted_regression[["forest"]]
csea_extracted_regression$initial_summary


test <- extract_stepwise_regression(numeric_mtrx, query = "finaloutcome",
                                    factors = c("Age"))

csa_extracted_regression <- extract_stepwise_regression(numeric_mtrx, query = "finaloutcome",
...
dev.off()
csa_extracted_regression[["forest"]]
csa_extracted_regression$initial_summary

cse_extracted_regression <- extract_stepwise_regression(numeric_mtrx, query = "finaloutcome",
...
dev.off()
cse_extracted_regression[["forest"]]
cse_extracted_regression$initial_summary
```
...
initial_queries <- c("Sex", "Ethnicity", "Age",
                     ...
                     "Adherence", "parasitehostratio",
                     "finaloutcome")
t_initial_mtrx <- pData(t_clinical_nobiop)[, initial_queries]

t_initial_mtrx[["parasitehostratio"]] <- log10(t_initial_mtrx[["parasitehostratio"]])
...
```{r}
t_sea_extracted_regression <- extract_stepwise_regression(t_numeric_mtrx, query = "finaloutcome",
...
dev.off()
t_sea_extracted_regression[["forest"]]
t_sea_extracted_regression[["initial_summary"]]

t_sa_extracted_regression <- extract_stepwise_regression(t_numeric_mtrx, query = "finaloutcome",
                                                         factors = c("Sex", "Age"),
...
dev.off()
t_sa_extracted_regression[["forest"]]
t_sa_extracted_regression[["initial_summary"]]

t_se_extracted_regression <- extract_stepwise_regression(t_numeric_mtrx, query = "finaloutcome",
...
dev.off()
t_se_extracted_regression[["forest"]]
t_se_extracted_regression[["initial_summary"]]
```
