...
```{r}
t_visit_monocyte <- set_expt_conditions(t_visitcf_monocyte,
                                        fact = "visitnumber") %>%
...
```{r}
t_visit_eosinophil <- set_expt_conditions(t_visitcf_eosinophil,
                                            fact = "visitnumber") %>%
  set_expt_batches("finaloutcome") %>%
  set_expt_colors(color_choices[["visit"]])
...
```{r}
t_visit_neutrophil <- set_expt_conditions(t_visitcf_neutrophil,
                                          fact = "visitnumber") %>%
  set_expt_batches("finaloutcome") %>%
  set_expt_colors(color_choices[["visit"]])
